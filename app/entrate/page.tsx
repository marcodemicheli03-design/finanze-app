...
import { addIncome, deleteIncome, addIncomeCategory } from "@/app/actions";
import PeriodFilter from "@/components/PeriodFilter";
import PieChart from "@/components/PieChart";
import { formatEuro, todayLocalISO } from "@/lib/date";
import { getPeriodo } from "@/lib/periodo";
import { breakdownEntrateNelPeriodo } from "@/lib/patrimonio";
...
export default async function EntratePage({
  ...
  const breakdown = await breakdownEntrateNelPeriodo(supabase, periodo.start, periodo.end);
    ...
    <main style={{ padding: "24px 20px 32px", maxWidth: 640, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        <details>
          ...
          >
            <select name="fonte" required style={inputStyle} defaultValue="">
      ...
      <details className="card" style={{ padding: 16, marginBottom: 16 }}>
        ...
        <form action={addIncomeCategory} style={{ display: "flex", gap: 8, marginTop: 12 }}>
